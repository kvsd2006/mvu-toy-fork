...
| 序号 | 项目 | 部署目标 | 状态 |
|---|---|---|---|
| 01 | [动态肉体档案](./01-body-archive/) | 悬浮球 JS + ZOD + MVU 规则 | 可用（v0.5.0，基线 V3.6.11 / 上游 V20260917） |
...
| 2026-09-23 | 01 子项目基线升级至轮回战场 V3.6.11（上游 V20260917，卡已改为 import 型）；跟改变量根名 `主角`→`角色`，产出 dist/V20260917 |
