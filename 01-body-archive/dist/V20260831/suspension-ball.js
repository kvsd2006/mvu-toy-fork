    ...
    */
    ...
    function handleShopRefresh(reqText, worldBookContent) {
       ...
       var sysPrompt = ''
            ...
            + '      * 升级只能强化、调整或明确改造替换目标已有机制，不得凭空新增未定义机制\n'
            + '      * 若原物品不存在对应机制，升级不得自行创造该机制。\n'
            + '      * 禁止生成暴击率、命中率、闪避率、韧性、装备耐久、冷却缩减、概率、百分比等未被系统定义的机制。\n'
            + '   - 必须生成升级后的完整成品面板，禁止使用词条增量补丁；必须填写与玩家数据完全一致的【替换目标】。\n'
            + '   - 【阶位字段】:\n'
            ...
            + '      * 升级商品必须完整继承替换目标的有效词条。\n'
            + '      * 未改变的词条必须原样保留。\n'
            + '      * 强化、合并或替换词条时必须明确记录原词条→新词条。\n'
            + '      * 禁止以“性能提升”“能力强化”等模糊描述代替具体效果。\n'
